            ...
            <div class="row justify-content-center no-gutters vertical-align">
                ...
                <div class="col-lg-4 col-md-6 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        ...
                        <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Register</h3>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="section-field mb-20">
                                <label class="mb-10" for="password_confirmation">Password Confirmation</label>
                            ...
                            <button class="button"><span>Register</span><i class="fa fa-check"></i></button>
                        </form>
                        <p class="mt-20 mb-0">Already Have Account? <a href="{{route('login')}}"><span class="text-success">Login From here</span></a></p>
